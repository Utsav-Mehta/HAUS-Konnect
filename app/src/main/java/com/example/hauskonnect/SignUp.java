    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!mailId.contains("sot.pdpu.ac.in")){
                    email.setError("Please enter your PDPU mail ID");
                    return;
                }
                ...
                fAuth.createUserWithEmailAndPassword(mailId,Password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            FirebaseUser fuser = fAuth.getCurrentUser();  userID = fAuth.getCurrentUser().getUid();
